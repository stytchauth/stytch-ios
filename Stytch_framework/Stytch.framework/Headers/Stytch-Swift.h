...
#ifndef STYTCH_SWIFT_H
#define STYTCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Stytch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Stytch : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Stytch * _Nonnull shared;)
+ (Stytch * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
@class StytchResult;
enum StytchError : NSInteger;

SWIFT_PROTOCOL_NAMED("StytchDelegate")
@protocol StytchDelegate
@optional
...
SWIFT_CLASS_NAMED("StytchEvent")
@interface StytchEvent : NSObject
...
SWIFT_CLASS_NAMED("StytchTextStyle")
@interface StytchTextStyle : NSObject
...
SWIFT_CLASS_NAMED("StytchUI")
@interface StytchUI : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) StytchUI * _Nonnull shared;)
+ (StytchUI * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@property (nonatomic, readonly, strong) StytchUICustomization * _Nonnull customization;
- (void)showUIFrom:(UIViewController * _Nonnull)presenter delegate:(id <StytchSDKDelegate> _Nonnull)delegate;
@end


SWIFT_CLASS_NAMED("StytchUICustomization")
@interface StytchUICustomization : NSObject
@property (nonatomic, readonly, strong) StytchTextStyle * _Nonnull titleStyle;
@property (nonatomic) BOOL showTitle;
@property (nonatomic, readonly, strong) StytchTextStyle * _Nonnull subtitleStyle;
@property (nonatomic) BOOL showSubtitle;
@property (nonatomic, readonly, strong) StytchTextStyle * _Nonnull inputTextStyle;
@property (nonatomic, readonly, strong) StytchTextStyle * _Nonnull inputPlaceholderStyle;
...
@property (nonatomic, readonly, strong) StytchTextStyle * _Nonnull buttonTextStyle;
