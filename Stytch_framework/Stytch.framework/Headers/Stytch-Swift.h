...
SWIFT_PROTOCOL_NAMED("StytchMagicLinkDelegate")
@protocol StytchMagicLinkDelegate
@optional
...
@interface StytchMagicLinkUI : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) StytchMagicLinkUI * _Nonnull shared;)
+ (StytchMagicLinkUI * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
