...
final class SSODiscoveryFallbackViewController: BaseViewController<SSODiscoveryFallbackState, SSODiscoveryFallbackViewModel> {
    ...
    override func configureView() {
        ...
        let subtitleLabel = UILabel.makeSubtitleLabel(text: "Please input the Organization's unique slug to continue. If you don't know the unique slug, log inthrough another method to view all of your available Organizations.")
