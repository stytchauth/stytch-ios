...
/*
 ...
 For example: stytch_continue → stytch.continue
...
extension LocalizationManager {
    static var stytch_continue: String {
        NSLocalizedString("stytch.continue", value: "Continue", comment: "Title of the Continue button throughout the Stytch prebuilt UI.")
    }
...
// Strings For B2C
extension LocalizationManager {
    static var stytch_b2c_auth_title: String {
        NSLocalizedString("stytch.b2c.auth.title", value: "Sign up or log in", comment: "Title of the home screen")
    }

    static var stytch_b2c_cancel: String {
        NSLocalizedString("stytch.b2c.cancel", value: "Cancel", comment: "")
    }

    static var stytch_b2c_check_email: String {
        NSLocalizedString("stytch.b2c.check.email", value: "Check your email", comment: "")
    }

    static var stytch_b2c_check_email_for_password: String {
        NSLocalizedString("stytch.b2c.check.email.for.password", value: "Check your email to set a new password", comment: "")
    }

    static var stytch_b2c_confirm: String {
        NSLocalizedString("stytch.b2c.confirm", value: "Send link", comment: "")
    }
    ...
    static var stytch_b2c_didnt_get_it: String {
        NSLocalizedString("stytch.b2c.didnt.get.it", value: "Didn't get it? ", comment: "")
    }

    static var stytch_b2c_email: String {
        NSLocalizedString("stytch.b2c.email", value: "Email", comment: "")
    }

    static var stytch_b2c_email_input_title: String {
        NSLocalizedString("stytch.b2c.email.input.title", value: "Email", comment: "")
    }
    ...
    static var stytch_b2c_error_title: String {
        NSLocalizedString("stytch.b2c.error.title", value: "Error", comment: "")
    }

    static var stytch_b2c_forgot_password: String {
        NSLocalizedString("stytch.b2c.forgot.password", value: "Forgot password?", comment: "")
    }

    static var stytch_b2c_invalid_email: String {
        NSLocalizedString("stytch.b2c.invalid.email", value: "Invalid email address, please try again.", comment: "")
    }

    static var stytch_b2c_invalid_number: String {
        NSLocalizedString("stytch.b2c.invalid.number", value: "Invalid number, please try again.", comment: "")
    }

    static var stytch_b2c_link_to_reset_password_sent: String {
        NSLocalizedString("stytch.b2c.link.to.reset.password.sent", value: "A link to reset your password was sent to you at ", comment: "")
    }

    static var stytch_b2c_login_link_sent: String {
        NSLocalizedString("stytch.b2c.login.link.sent", value: "A login link was sent to you at ", comment: "")
    }

    static var stytch_b2c_login_without_password: String {
        NSLocalizedString("stytch.b2c.login.without.password", value: "Login without a password", comment: "")
    }

    static var stytch_b2c_make_sure_acount_secure: String {
        NSLocalizedString("stytch.b2c.make.sure.acount.secure", value: "We want to make sure your account is secure and that it’s really you logging in. A login link was sent to you at ", comment: "")
    }

    static func stytch_b2c_new_code_will_be_sent(email: String) -> String {
        String.localizedStringWithFormat(
            NSLocalizedString("stytch.b2c.new.code.will.be.sent", value: "A new link will be sent to %@.", comment: ""),
            email
        )
    }

    static var stytch_b2c_ok: String {
        NSLocalizedString("stytch.b2c.ok", value: "OK", comment: "")
    }

    static var stytch_b2c_or_separator: String {
        NSLocalizedString("stytch.b2c.or.separator", value: "or", comment: "")
    }
    ...
    static var stytch_b2c_password_breach: String {
        NSLocalizedString("stytch.b2c.password.breach", value: "A different site where you use the same password had a security issue recently. For your safety, an email was sent to you at ", comment: "")
    }
    ...
    static var stytch_b2c_password_input_label: String {
        NSLocalizedString("stytch.b2c.password.input.label", value: "Password", comment: "")
    }
    ...
    static var stytch_b2c_period: String {
        NSLocalizedString("stytch.b2c.period", value: ".", comment: "")
    }

    static var stytch_b2c_recovery_code_placeholder: String {
        NSLocalizedString("stytch.b2c.recovery.code.placeholder", value: "Enter backup code", comment: "")
    }

    static var stytch_b2c_resend_code: String {
        NSLocalizedString("stytch.b2c.resend.code", value: "Resend link", comment: "")
    }

    static var stytch_b2c_resend_email: String {
        NSLocalizedString("stytch.b2c.resend.email", value: "Resend email", comment: "")
    }

    static var stytch_b2c_text: String {
        NSLocalizedString("stytch.b2c.text", value: "Text", comment: "")
    }

    static var stytch_b2c_to_create_password: String {
        NSLocalizedString("stytch.b2c.to.create.password", value: " to create a password for your account.", comment: "")
    }

    static var stytch_b2c_to_reset_password: String {
        NSLocalizedString("stytch.b2c.to.reset.password", value: " to reset your password.", comment: "")
    }

    static var stytch_b2c_use_password_instead: String {
        NSLocalizedString("stytch.b2c.use.password.instead", value: "Use password instead", comment: "")
    }

    static var stytch_b2c_whatsApp: String {
        NSLocalizedString("stytch.b2c.whatsApp", value: "WhatsApp", comment: "")
    }
}
...
extension LocalizationManager {
    ...
    static var stytch_b2b_sso_discovery_button_title: String {
        NSLocalizedString(
            "stytch.b2b.sso.hardcoded.button.title",
