...
private extension UIColor {
    ...
    static let charcoal = UIColor(red: 0.10, green: 0.19, blue: 0.24, alpha: 1.00)
    // #8296A1 dark.text.disabled, light.text.disabled
    static let steel = UIColor(red: 0.51, green: 0.59, blue: 0.63, alpha: 1.00)
    // #5C727D greyscale, light.text.secondary, dark.border.active
    static let slate = UIColor(red: 0.36, green: 0.45, blue: 0.49, alpha: 1.00)
    // #354D5A greyscale, dark.border.subtle
    static let ink = UIColor(red: 0.21, green: 0.30, blue: 0.35, alpha: 1.00)
    // #ADBCC5 dark.text.secondary, light.border.active
    static let cement = UIColor(red: 0.68, green: 0.74, blue: 0.77, alpha: 1.00)
    // #F3F5F6 dark.text.primary
    static let chalk = UIColor(red: 0.95, green: 0.96, blue: 0.96, alpha: 1.00)
    // #FFD4CD dark.text.danger
    static let peach = UIColor(red: 1.00, green: 0.83, blue: 0.80, alpha: 1.00)
    // #C6FFE0 dark.text.success
    static let mint = UIColor(red: 0.78, green: 1.00, blue: 0.88, alpha: 1.00)
    // #8B1214 light.border.danger
    static let maroon = UIColor(red: 0.55, green: 0.07, blue: 0.08, alpha: 1.00)
    // #0C5A56 light.text.success
    static let pine = UIColor(red: 0.05, green: 0.35, blue: 0.34, alpha: 1.00)
    // #E5E8EB light.border.subtle
    static let fog = UIColor(red: 0.90, green: 0.91, blue: 0.92, alpha: 1.00)
}
