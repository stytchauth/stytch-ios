...
public extension StytchClient.MagicLinks.Email {
    ...
    struct Parameters: Encodable, Equatable, Sendable {
        ...
        let signupExpirationMinutes: Minutes?
        ...
        /**
         ...
         - Parameters:
           ...
           - loginExpirationMinutes: Set the expiration for the login email magic link, in minutes. By default, it expires in 1 hour. The minimum expiration is 5 minutes and the maximum is 7 days (10080 mins).
           ...
           - signupExpirationMinutes: Set the expiration for the sign-up email magic link, in minutes. By default, it expires in 1 week. The minimum expiration is 5 minutes and the maximum is 7 days (10080 mins).
        ...
        public init(
            ...
            signupExpirationMinutes: Minutes? = nil,
            ...
            self.signupExpirationMinutes = signupExpirationMinutes
        ...
        public static func == (lhs: Parameters, rhs: Parameters) -> Bool {
            lhs.loginMagicLinkUrl == rhs.loginMagicLinkUrl &&
                ...
                lhs.signupExpirationMinutes == rhs.signupExpirationMinutes &&
