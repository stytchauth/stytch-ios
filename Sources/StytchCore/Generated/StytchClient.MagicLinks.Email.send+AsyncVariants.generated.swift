...
public extension StytchClient.MagicLinks.Email {
    /// Wraps Stytch's email magic link [send](https://stytch.com/docs/api/send-by-email) endpoint. Requests an email magic link for an existing user to log in or to attach this email factor to their current account.
