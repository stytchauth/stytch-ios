...
extension PollingClient {
    /// A polling client which tries to complete every 3 minutes, and will retry (w/ exponential delays) upon errors, for up to a total of approximately 124 seconds.
